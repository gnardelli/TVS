...
public class DynamicListView extends ListView {
    ...
    public List<StackSite> mStackSite;
    ...
    public boolean onTouchEvent (MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                //DynamicListView sitesLocal;
                //LayoutInflater iInflater= LayoutInflater.from(mContextLoc);
                //View v = iInflater.inflate(R.layout.tablocal, null, true);
                //tabLocal.sitesLocal = (DynamicListView) v.findViewById(R.id.sitesLocal);
                StackSite sSite;
                ...
                View v;
                PlaylistValues plv = new PlaylistValues();
                for (int i = 0; i < tabLocal.sitesLocal.getCount(); i++) {

                    sSite = new StackSite();

                    v = tabLocal.sitesLocal.getAdapter().getView(i, null, null);

                    plv.nameTxt = (TextView) v.findViewById(R.id.nameTxt);
                    plv.oldNameTxt = (TextView) v.findViewById(R.id.oldNameTxt);
                    plv.aboutTxt = (TextView) v.findViewById(R.id.aboutTxt);
                    plv.iconImg = (ImageView) v.findViewById(R.id.iconImg);

                    sSite.setAbout((String) plv.aboutTxt.getText());
                    sSite.setName((String) plv.nameTxt.getText());
                    sSite.setTypeStream(-1);  // this means that this value will not be updated


                    sSite.setPosition(i+1);   // this number will be the position of the list after the update
                    MyDBHandler dbHandler;
                    dbHandler = new MyDBHandler(tabLocal.Fa.getContext(), null, null,1);
                    dbHandler.updateSite(sSite, (String)plv.nameTxt.getText() );
                ...
                //Toast.makeText(mContextLoc,  " is added in Local Playlist", Toast.LENGTH_SHORT).show();
                break;
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mStackSite, originalItem, getPositionForView(switchView));
    ...
    public void setCheeseList(List<StackSite> stackSite) {
        mStackSite = stackSite;
    }
